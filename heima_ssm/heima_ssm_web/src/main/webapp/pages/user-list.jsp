									...
									<c:forEach items="${pageInfo.list}" var="user">
										<tr>
											...
											<td class="text-center">
												...
												<a href="${pageContext.request.contextPath}/user/findupdateRole?id=${user.id}" class="btn bg-olive btn-xs">修改角色</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
						...
						<div class="box-tools pull-right">
							<ul class="pagination">
								...
								<c:forEach begin="1" end="${pageInfo.pages}" var="info">
									<li><a href="${pageContext.request.contextPath}/user/findAll?page=${info}&size=${pageInfo.pageSize}">${info}</a></li>
								</c:forEach>
