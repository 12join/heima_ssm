...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
      ...
      <c:forEach items="${role.users}" var="user">
		  ...
		  <div class="col-md-4 data">
			  <input type="text" class="form-control" placeholder="用户电话"
					 value="${user.phoneNum}" readonly="readonly">
		  </div>
		  <div class="col-md-2 title">用户状态</div>
		  <div class="col-md-4 data">
			  <input type="text" class="form-control" placeholder="用户状态"
					 value="${user.statusStr}" readonly="readonly">
		  </div>
	  </c:forEach>
			...
			<!--订单信息/--> <!--游客信息-->
				<div class="panel panel-default">
					...
					<div class="row data-type">
						...
						<div class="col-md-4 data text">${role.id}</div>

						<div class="col-md-2 title">角色名</div>
						<div class="col-md-4 data text">${role.roleName}</div>

						<div class="col-md-2 title">角色状态</div>
						<div class="col-md-10 data text">${role.roleDesc}</div>
					</div>
				</div>
			...
			<div class="panel panel-default">
				<div class="panel-heading">权限表信息</div>
				<div class="row data-type">

					<div class="col-md-2 title">权限id</div>
					<div class="col-md-4 data text">${permissions.id}</div>

					<div class="col-md-2 title">权限名</div>
					<div class="col-md-4 data text">${permissions.permissionName}</div>

					<div class="col-md-2 title">权限地址</div>
					<div class="col-md-10 data text">${permissions.url}</div>
				</div>
			</div>
			</c:forEach>
					<div class="box-tools text-center">
